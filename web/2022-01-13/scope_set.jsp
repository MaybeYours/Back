<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//내장객체에 인스턴스를 속성값으로 저장(변경)하기 위해 setAttribute() 메소드 호출
	// => setAttribute() 메소드에 속성명(문자열 - 식별자)과 속성값(인스턴스)을 전달하여 내장객체에 저장
	// => 내장객체에 같은 속성명이 있는 경우 속성값 변경 
...
<body>
	...
	<hr>
	<%
		//내장객체에 저장된 속성값(인스턴스)을 반환하기 위해 getAttribute() 메소드 호출
		// => getAttribute() 메소드에 속성명을 전달하여 속성명으로 저장된 속성값을 반환
