<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 회원정보를 입력받는 JSP 문서 --%>
<%-- => [회원가입]을 클릭한 경우 회원정보 저장페이지(member_join_action.jsp)로 이동 - 입력값(회원정보) 전달 --%>    
<%-- => 회원정보 저장페이지로 이동 전 사용자 입력값에 대한 검증 - 입력검증, 형식검증, 중복검증(AJAX) 등 --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	//아이디 입력태그에서 키보드를 누른 경우 호출되는 이벤트 처리 함수
	document.getElementById("id").onkeyup=function() {
		...
		//아이디를 중복 검사하기 위한 웹프로그램을 AJAX 기능으로 요청하여 응답결과를 제공받아 처리
