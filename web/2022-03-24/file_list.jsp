...
<body>
	...
	<p>
		<button type="button" onclick="location.href='${pageContext.request.contextPath}/file_upload';">업로드</button>
	</p>
	
	<script type="text/javascript">
	function fileDelete(num) {
		if(confirm("자료를 정말로 삭제 하시겠습니까?")) {
			location.href="${pageContext.request.contextPath}/file_delete/"+num;
		}
	}
	
	function fileDownload(num) {
		location.href="${pageContext.request.contextPath}/file_download/"+num;
	}
	</script>
</body>
</html>