...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 회원정보를 전달받아 MEMBER 테이블에 삽입하여 저장하고 로그인 정보 입력페이지(member_login.jsp)로 이동하는 JSP 문서 --%>    
<%
	...
	//템플릿 페이지(index.jsp)의 Content 영역에 포함되는 JSP 문서이므로 리퀘스트 메세지 관련 정보 변경 불가능
	// => 템플릿 페이지(index.jsp)에서 리퀘스트 메세지 관련 정보 변경
	...
	//로그인 정보 입력페이지(member_login.jsp)로 이동
	out.println("<script type='text/javascript'>");
